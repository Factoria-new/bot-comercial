...
echo ========================================
echo.
echo Converting NAVIGATE_4K_S50_loop@sm.mp4...
echo This may take a few minutes depending on video length.
echo.

ffmpeg -i "NAVIGATE_4K_S50_loop@sm.mp4" -c:v libx264 -x264-params keyint=1:min-keyint=1:scenecut=0 -crf 20 -preset medium -c:a copy "NAVIGATE_4K_S40-scrolly@md_OPTIMIZED.mp4"
...
if %errorlevel% equ 0 (
    ...
    echo ========================================
    echo.
    echo Original: NAVIGATE_4K_S50_loop@sm.mp4
    echo Optimized: NAVIGATE_4K_S50_loop@sm_OPTIMIZED.mp4
    echo.
