import { Mail, Linkedin, Instagram, Scissors } from 'lucide-react';

/**
 * LPFooter - Beleza Landing Page
            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
                    <div className="md:col-span-2 space-y-6">
                        ...
                        >
                            Transforme seu WhatsApp em uma secretaria virtual com IA. Agendamentos automaticos, lembretes e sincronizacao com Google Agenda.
                        </p>
                ...
                <div
                    className="pt-8"
                    style={{ borderTop: '1px solid hsl(var(--beleza-border))' }}
                >
