import { Calendar, Mic, Moon, Sparkles } from "lucide-react";

export const SolutionSection = () => {
    const features = [
        {
            icon: <Calendar className="w-6 h-6 text-lp-accent" />,
            title: "Sincronia Total",
            description: "O cliente escolhe o horário no WhatsApp e o Caji bloqueia automaticamente no seu Google Agenda. Sem conflitos.",
            delay: "0",
        },
        {
            icon: <Mic className="w-6 h-6 text-lp-accent" />,
            title: "Áudios Naturais",
            description: "Envie áudios com sua voz (ou da sua recepcionista) explicando procedimentos e pós-venda. Ninguém percebe que é robô.",
            delay: "100",
        },
        {
            icon: <Moon className="w-6 h-6 text-lp-accent" />,
            title: "Agenda Noturna",
            description: "Muitos clientes lembram de marcar horário antes de dormir. O Caji agenda para você às 23h, meia-noite...",
            delay: "200",
        },
        {
            icon: <Sparkles className="w-6 h-6 text-lp-accent" />,
            title: "Filtro de Curiosos",
            description: "Tira dúvidas de preço e procedimento automaticamente e só te avisa quando o agendamento está confirmado.",
            delay: "300",
        }
    ];
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 lg:order-2 space-y-8 animate-slide-in-right">
                        ...
                        <p className="text-lg text-lp-muted-foreground font-sans leading-relaxed">
                            O Caji Assist é a recepcionista mais eficiente que você já viu. Ela nunca dorme, nunca fica doente e cobra menos que um corte de cabelo por mês.
                        </p>
                        ...
                        <ul className="space-y-4 pt-4">
                            <li className="flex items-center gap-3 text-lp-foreground">
                                ...
                                Integração Perfeita com Google Agenda
                            </li>
                            <li className="flex items-center gap-3 text-lp-foreground">
                                <span className="w-1.5 h-1.5 rounded-full bg-lp-accent shadow-[0_0_10px_#19B159]" />
                                Lembretes Automáticos (Fim do No-Show)
                            </li>
                            <li className="flex items-center gap-3 text-lp-foreground">
                                <span className="w-1.5 h-1.5 rounded-full bg-lp-accent shadow-[0_0_10px_#19B159]" />
                                Aumenta Ticket Médio com dicas e ofertas
                            </li>
                        </ul>
                    </div>
                </div>
