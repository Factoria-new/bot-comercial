...
import { X, Loader2, Check, LogOut } from "lucide-react";
                                ...
                                <div>
                                    ...
                                    <p className="text-white/50 text-sm">
                                        {connectionState === 'connected' ? 'Conectado!' :
                                            connectionState === 'ready' ? 'Escaneie o QR Code' :
                                                connectionState === 'generating' ? 'Gerando QR Code...' :
                            ...
                            <div className="flex flex-col items-center justify-center py-8">
                                ...
                                <div className="flex flex-col gap-3 w-full">
                                    ...
                                    <Button
                                        variant="ghost"
                                        onClick={() => {
                                            onDisconnect && onDisconnect(1); // Assuming instance 1
                                            onClose();
                                        }}
